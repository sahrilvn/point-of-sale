        ...
        <div class="row">
            ...
            <center><?php echo $this->session->flashdata('msg');?></center>
                <h1 class="page-header">Data
                    ...
                    <div class="pull-right" style="padding-right: 10px;"><a href="<?php echo site_url('barang/barang_basah') ?>" class="btn btn-sm btn-primary"><span class="fa fa-share"></span> Barang Basah</a></div>
