   ...
   ?>
    ...
    <div class="container">
            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                <?php 
                    ...
                    foreach ($data->result_array() as $a):
                        ...
                        $norek=$a['suplier_no_rekening'];
                        $balance=$a['suplier_balance'];
                        $debit=$a['suplier_debit'];
        ...
        <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo site_url('suplier/tambah_suplier')?>">
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo site_url('Suplier/edit_suplier')?>">
                        <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >No Rekening</label>
                        <div class="col-xs-9">
                            <input name="norek" class="form-control" type="text" placeholder="No Rekening Suplier..." value="<?php echo $norek;?>" style="width:280px;" required>
                        </div>
                    </div>   
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Balance</label>
                        <div class="col-xs-9">
                            <input name="balance" class="form-control" type="text" placeholder="Balance Suplier..." value="<?php echo $balance;?>" style="width:280px;" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Debit</label>
                        <div class="col-xs-9">
                            <input name="debit" class="form-control" type="text" placeholder="Debit Suplier..." value="<?php echo $debit;?>" style="width:280px;" required>
                        </div>
                    </div>
        ...
        <?php
                ...
                <div id="modalHapusPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo site_url('Suplier/hapus_suplier')?>">
                        <div class="modal-body">
